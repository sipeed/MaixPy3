...
class Ui_Mainui(object):
    def setupUi(self, Mainui):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/ICONS/logo.jpg"))
        ...
        self.verticalLayout_2.addWidget(self.setupButton)
