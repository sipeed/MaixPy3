...
PYBIND11_MODULE(_maix_image, mo)
{
    ...
    pybind11::class_<maix_image>(mo, "Image")
        ...
        .def("draw_rectangle", &maix_image::_draw_rectangle, py::arg("x"), py::arg("y"), py::arg("w"), py::arg("h"), py::arg("color") = std::vector<int>{127, 127, 127}, py::arg("thickness") = 1, py::arg("cv_imlib") = 0)
