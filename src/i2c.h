...
size_t i2c_read(const I2CDevice *device, unsigned int iaddr, void *buf, size_t len);
size_t i2c_write(const I2CDevice *device, unsigned int iaddr, const void *buf, size_t len);

/* I2c ioctl read, write can set i2c flags */
size_t i2c_ioctl_read(const I2CDevice *device, unsigned int iaddr, void *buf, size_t len);
size_t i2c_ioctl_write(const I2CDevice *device, unsigned int iaddr, const void *buf, size_t len);

/* I2C read / write handle function */
typedef size_t (*I2C_READ_HANDLE)(const I2CDevice *dev, unsigned int iaddr, void *buf, size_t len);
typedef size_t (*I2C_WRITE_HANDLE)(const I2CDevice *dev, unsigned int iaddr, const void *buf, size_t len);
