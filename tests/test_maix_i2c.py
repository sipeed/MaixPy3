...
class _maixTest(unittest.TestCase):
    def setUp(self):
        self.i2c_size = 256
        # 24C04 E2PROM test
        self.i2c = _maix.I2CDevice(bus="/dev/i2c-1", addr=0x56, page_bytes=16)
    ...
    def test_init(self):
        ...
        with self.assertRaises(TypeError):
            _maix.I2CDevice("/dev/i2c-1")

        with self.assertRaises(IOError):
            _maix.I2CDevice("/dev/i2c-100", 0x56)

    def test_getattr(self):
        i2c = _maix.I2CDevice("/dev/i2c-1", 0x56)
    ...
    def test_flags(self):
        ...
        i2c = _maix.I2CDevice("/dev/i2c-1", 0x56, flags=1)
        ...
        i2c.flags = _maix.I2C_M_NOSTART
        self.assertEqual(i2c.flags, _maix.I2C_M_NOSTART)

        i2c.flags = _maix.I2C_M_IGNORE_NAK
        self.assertEqual(i2c.flags, _maix.I2C_M_IGNORE_NAK)

    def test_delay(self):
        i2c = _maix.I2CDevice("/dev/i2c-1", 0x56)
        self.assertEqual(i2c.delay, 1)

        i2c = _maix.I2CDevice("/dev/i2c-1", 0x56, delay=0)
    ...
    def test_tenbit(self):
        ...
        i2c = _maix.I2CDevice("/dev/i2c-1", 0x56, tenbit=1)
    ...
    def test_page_bytes(self):
        ...
        i2c = _maix.I2CDevice("/dev/i2c-1", 0x56, page_bytes=16)
    ...
    def test_iaddr_bytes(self):
        ...
        i2c = _maix.I2CDevice("/dev/i2c-1", 0x56, iaddr_bytes=2)
